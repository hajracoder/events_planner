  ...
  return (
    <div className="p-6 space-y-8 relative">
      ...
      <Card className="shadow-lg">
        <CardContent className="p-6">
          <h2 className="text-2xl font-bold text-pink-700">📝 Book Your Slot</h2>
          <p className="text-sm text-gray-600 mt-1">Maximum 200 guests allowed.</p>
          <button
...
//   const [_, setUser] = useState<any>(null); // warning fix ke liye _

//   const handleLoginSuccess = () => {
//     console.log("Login Success 🎉");
//     setShowBookingModal(false); // modal close after login
//   };
